...
export class Gatt{
    ...
    characteristics: any[] = [
        ...
        {uuid:'F000AA02-0451-4000-B000-000000000000',name:'IR Temperature Config', type: 'complex', unit:''},
        {uuid:'F000AA03-0451-4000-B000-000000000000',name:'IR Temperature Period', type: 'complex', unit:'ms'},
